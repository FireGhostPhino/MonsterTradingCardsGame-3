...
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer pat-mtcgToken" -d "[\"3\", \"5\", \"6\", \"7\"]"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer kienboec-mtcgToken"
echo.
...
curl -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d "[\"3\", \"5\", \"6\", \"7\"]"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo.
...
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer pat-mtcgToken"
echo.
curl -X GET http://localhost:10001/deck --header "Authorization: Bearer altenhof-mtcgToken"
echo.
echo.
...
echo kienboec
curl -X GET http://localhost:10001/deck?format=plain --header "Authorization: Bearer pat-mtcgToken"
echo.
echo.
echo altenhof
...
curl -X POST http://localhost:10001/chatroom --header "Content-Type: application/json" --header "Authorization: Bearer test9-mtcgToken" -d "{\"Username\":\"test9\", \"MessageText\":\"Nachricht test\"}"
echo.
echo Receive Chatroom Messages
curl -X GET http://localhost:10001/chatroom --header "Authorization: Bearer test9-mtcgToken"
echo.
echo.
